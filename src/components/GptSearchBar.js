...
const GptSearchBar = () => {
  ...
  return (
    <div className="">
      <form
        className="bg-black text-white w-5/12 p-2  mx-auto grid grid-cols-12"
      ...
      >
        <input
          ...
          className="px-4 py-2 m-1 col-span-9 bg-white text-black"
        />
        <button className="bg-red-500 m-1 col-span-3" onClick={handleSearch}>
